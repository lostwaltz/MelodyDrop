...
namespace Engine
{
    ...
    public abstract class SingletonMono<T> : MonoBehaviour, ISingletonMonoInterface where T : SingletonMono<T>
    {
        ...
        public virtual void InitializeSingleton()
        {
            ...
            {
                if (oldInstances.Any(old => InitializationTime > old.GetComponent<SingletonMono<T>>().InitializationTime))
                {
                    Destroy(gameObject);
                    return;
                }
